...
public class registro1 extends AppCompatActivity {
    ...
    private boolean validate(String nom, String user, String ape){
        //el booleano fillDocument servira para calcular si faltan espacios por llenar, ya que si llega a faltar uno, automaticamente se volvera falso por lo que no entrara al resto de la funcion
        boolean v=true;
